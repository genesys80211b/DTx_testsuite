...
MAKEFILE = rffe_mex.mk

include rffe_mex.mki
...
MEX_FILE_NAME_WO_EXT = rffe_mex1
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/rffe"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/rffe/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rffe/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rffe/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rffe/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
