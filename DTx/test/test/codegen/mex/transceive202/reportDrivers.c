...
static emlrtRSInfo nb_emlrtRSI = { 6, "reportDrivers",
...
static emlrtRSInfo qb_emlrtRSI = { 105, "mapiPrivate",
  "/usr/local/MATLAB/R2014b/SupportPackages/usrpradio/toolbox/shared/sdr/sdru/usrp_uhd_mapi/mapiPrivate.m"
};
                   ...
                   flatAddrList_size[2])
{
  ...
  char_T cv68[6];
  int32_T i;
  static const char_T cv69[6] = { 's', 'i', 'l', 'e', 'n', 't' };
  ...
  if (!isSetupsdruCalled) {
    ...
    emlrtInitCharArrayR2013a(&st, 6, m16, cv68);
    emlrtAssign(&y, m16);
