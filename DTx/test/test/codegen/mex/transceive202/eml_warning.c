...
static emlrtRSInfo tb_emlrtRSI = { 16, "eml_warning",
  "/usr/local/MATLAB/R2014b/toolbox/eml/lib/matlab/eml/eml_warning.m" };
...
{
  const mxArray *y;
  static const int32_T iv41[2] = { 1, 31 };

  const mxArray *m17;
  char_T cv70[31];
  int32_T i;
  static const char_T cv71[31] = { 's', 'd', 'r', 'u', ':', 'S', 'D', 'R', 'u',
  ...
  emlrtInitCharArrayR2013a(sp, 31, m17, cv70);
  emlrtAssign(&y, m17);
  u_size[0] = 1;
  ...
  b_y = NULL;
  m17 = emlrtCreateCharArray(2, u_size);
  emlrtInitCharArrayR2013a(sp, u_size[1], m17, (char_T *)u_data);
  emlrtAssign(&b_y, m17);
  st.site = &tb_emlrtRSI;
