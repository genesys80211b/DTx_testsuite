                   ...
                   varargout_2_size[2])
{
  ...
  char_T cv37[6];
  int32_T i;
  static const char_T cv38[6] = { 's', 'i', 'l', 'e', 'n', 't' };
  ...
  if (!isSetupsdruCalled) {
    ...
    emlrtInitCharArrayR2013a(sp, 6, m8, cv37);
    emlrtAssign(&y, m8);
    st.site = &sb_emlrtRSI;
                 ...
                 int32_T varargout_3_size[2])
{
  ...
  char_T cv35[6];
  int32_T i;
  static const char_T cv36[6] = { 's', 'i', 'l', 'e', 'n', 't' };
  ...
  if (!isSetupsdruCalled) {
    ...
    emlrtInitCharArrayR2013a(sp, 6, m7, cv35);
    emlrtAssign(&y, m7);
    st.site = &sb_emlrtRSI;
    setupsdru(&st, sdruroot(&st, &f_emlrtMCI), y, &g_emlrtMCI);
    isSetupsdruCalled = true;
