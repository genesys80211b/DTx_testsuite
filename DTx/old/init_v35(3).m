...
prm.DRxStateTransmitACK         = uint8(22);
prm.DRxStateDIFS                = uint8(23);
% Designated Transmitter (DTx) States
prm.DTxStateStart               = uint8(120);
...
prm.DTxStateEOT                 = uint8(14);
% Frame Check Sequence (FCS) CRC Parameters
prm.FCSPolynomial               = [31 30 26 25 24 18 15 14 12 11 10 8 6 5 4 3 1 0]; 
