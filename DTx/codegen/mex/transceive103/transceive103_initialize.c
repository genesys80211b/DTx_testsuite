 ...
 *
 * Code generation for function 'transceive103_initialize'
 *
 */
...
static void transceive103_once(void);
...
void transceive103_initialize(void)
{
...
/* End of code generation (transceive103_initialize.c) */
