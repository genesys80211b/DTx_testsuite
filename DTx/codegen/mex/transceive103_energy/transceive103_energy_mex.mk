...
MAKEFILE = transceive103_energy_mex.mk

include transceive103_energy_mex.mki


SRC_FILES =  \
	transceive103_energy_mexutil.c \
	...
	_coder_transceive103_energy_api.c \
	_coder_transceive103_energy_mex.c

MEX_FILE_NAME_WO_EXT = transceive103_energy_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/transceive103_energy"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/transceive103_energy/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/transceive103_energy/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/transceive103_energy/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
