...
void transceive103_energy_api(transceive103_energyStackData *SD, const mxArray *
  const prhs[9], const mxArray *plhs[2])
{
  ...
  transceive103_energy(SD, &st, d2s, ft, txGain, rxGain, centerFreqTx,
                       centerFreqRx, intFactor, decFactor, flag, dr, &ns);
...
/* End of code generation (_coder_transceive103_energy_api.c) */
