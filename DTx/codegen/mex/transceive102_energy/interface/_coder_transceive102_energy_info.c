 ...
 *
 * _coder_transceive102_energy_info.c
 *
 * Code generation for function '_coder_transceive102_energy_info'
 *
 */
...
#include "_coder_transceive102_energy_info.h"
...
static void b_info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, b_emlrt_marshallOut(
    "[E]/usr/local/MATLAB/V40_testsuite/DTx/transceive102_energy.m"), "context",
                100);
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", mxCreateString("transceive102_energy"));
...
/* End of code generation (_coder_transceive102_energy_info.c) */
