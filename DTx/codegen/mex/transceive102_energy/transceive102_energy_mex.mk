...
MAKEFILE = transceive102_energy_mex.mk

include transceive102_energy_mex.mki


SRC_FILES =  \
	transceive102_energy_mexutil.c \
	transceive102_energy_data.c \
	transceive102_energy_initialize.c \
...
MEX_FILE_NAME_WO_EXT = transceive102_energy_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/transceive102_energy"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/transceive102_energy/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/transceive102_energy/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/transceive102_energy/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
