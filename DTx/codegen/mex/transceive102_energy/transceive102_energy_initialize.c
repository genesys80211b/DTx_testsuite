 ...
 *
 * Code generation for function 'transceive102_energy_initialize'
 *
 */
...
static void transceive102_energy_once(void);
...
void transceive102_energy_initialize(void)
{
  ...
  if (emlrtFirstTimeR2012b(emlrtRootTLSGlobal)) {
    transceive102_energy_once();
  }
}

/* End of code generation (transceive102_energy_initialize.c) */
