 ...
 *
 * Code generation for function '_coder_transceive102_info'
 *
 */
...
#include "_coder_transceive102_info.h"
...
static void b_info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, b_emlrt_marshallOut(
    "[E]/usr/local/MATLAB/V40_testsuite/DTx/transceive102.m"), "context", 100);
...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, b_emlrt_marshallOut(
    "[E]/usr/local/MATLAB/V40_testsuite/DTx/transceive102.m"), "context", 8);
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", mxCreateString("transceive102"));
...
/* End of code generation (_coder_transceive102_info.c) */
