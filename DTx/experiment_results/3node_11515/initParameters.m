...
%buffer receiver variables
% numChunk: number of chunks to break up usrpFrameLength
numChunk = 1;
% chunkValue: value of chunks
chunkValue = usrpFrameLength/numChunk;
